...
uint8_t ICM20948_ACCEL_Init(ICM20948*, ACCEL_DLPF, ACCEL_FS, uint16_t, uint16_t);
...
uint16_t ICM20948_set_ACCEL_SAMPLE_RATE_DIV(ICM20948*, uint16_t);
uint16_t ICM20948_get_ACCEL_SAMPLE_RATE_DIV(ICM20948*);

float ICM20948_get_ACCEL_ODR_kHz(ICM20948*);
...
typedef enum{
    ...
    GYRO_AVG_FILTER_4 = 2,
    GYRO_AVG_FILTER_8 = 3,
    GYRO_AVG_FILTER_16 = 4,
    GYRO_AVG_FILTER_32 = 5,
    GYRO_AVG_FILTER_64 = 6,
    GYRO_AVG_FILTER_128 = 7
}GYRO_AVG_FILTER;
...
uint8_t ICM20948_set_FIFO_MODE(ICM20948* icm, FIFO_MODE_ENUM);
...
/*
    TO BE DONE;
*/
uint8_t ICM20948_ACCEL_BIAS_CONFIGURE(ICM20948*, int16_t);

/*
    GET ALL DATA FUNCTION
*/
uint8_t ICM20948_read_data(ICM20948*);
